...
module IEXHaskellSDK.Core where
...
-- | 
data IEXHaskellSDKConfig = IEXHaskellSDKConfig
...
-- | display the config
instance P.Show IEXHaskellSDKConfig where
  show c =
    T.printf
...
newConfig = do
    ...
    return $ IEXHaskellSDKConfig
        { configHost = "http://api.iextrading.com/1.0"
        , configUserAgent = "iex-haskell-sdk/0.1.0.0"
...
addAuthMethod config@IEXHaskellSDKConfig {configAuthMethods = as} a =
...
data IEXHaskellSDKRequest req contentType res accept = IEXHaskellSDKRequest
  { rMethod  :: NH.Method   -- ^ Method of IEXHaskellSDKRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of IEXHaskellSDKRequest
  , rParams   :: Params -- ^ params of IEXHaskellSDKRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (IEXHaskellSDKRequest req contentType res accept) NH.Method
rMethodL f IEXHaskellSDKRequest{..} = (\rMethod -> IEXHaskellSDKRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (IEXHaskellSDKRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f IEXHaskellSDKRequest{..} = (\rUrlPath -> IEXHaskellSDKRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (IEXHaskellSDKRequest req contentType res accept) Params
rParamsL f IEXHaskellSDKRequest{..} = (\rParams -> IEXHaskellSDKRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (IEXHaskellSDKRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f IEXHaskellSDKRequest{..} = (\rAuthTypes -> IEXHaskellSDKRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => IEXHaskellSDKRequest req contentType res accept -> param -> IEXHaskellSDKRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: IEXHaskellSDKRequest req contentType res accept -> param -> IEXHaskellSDKRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: IEXHaskellSDKRequest req contentType res accept -> param -> IEXHaskellSDKRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** IEXHaskellSDKRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> IEXHaskellSDKRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = IEXHaskellSDKRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: IEXHaskellSDKRequest req contentType res accept -> [NH.Header] -> IEXHaskellSDKRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: IEXHaskellSDKRequest req contentType res accept -> [NH.HeaderName] -> IEXHaskellSDKRequest req contentType res accept
...
setQuery :: IEXHaskellSDKRequest req contentType res accept -> [NH.QueryItem] -> IEXHaskellSDKRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: IEXHaskellSDKRequest req contentType res accept -> WH.Form -> IEXHaskellSDKRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: IEXHaskellSDKRequest req contentType res accept -> NH.Part -> IEXHaskellSDKRequest req contentType res accept
...
_setBodyBS :: IEXHaskellSDKRequest req contentType res accept -> B.ByteString -> IEXHaskellSDKRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: IEXHaskellSDKRequest req contentType res accept -> BL.ByteString -> IEXHaskellSDKRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => IEXHaskellSDKRequest req contentType res accept -> P.Proxy authMethod -> IEXHaskellSDKRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: IEXHaskellSDKConfig
    -> a
    -> IEXHaskellSDKRequest req contentType res accept
    -> IO (IEXHaskellSDKRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> IEXHaskellSDKConfig
  -> IO (IEXHaskellSDKRequest req contentType res accept)
_applyAuthMethods req config@(IEXHaskellSDKConfig {configAuthMethods = as}) =
  foldlM go req as
  where
